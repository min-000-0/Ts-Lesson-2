...
import type { CreateProductParams, UploadImageResponse, DeleteProductResponse, CreateProductResponse, EditProductParams, GetProductsResponse, EditProductResponse } from '@/types/product'
